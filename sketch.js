...
function draw() {
  ...
  drawSprites();
  text("Score: " + score1, monkey.x+100, 20);
  text("Health: " + health, monkey.x+170, 20);
}

function createRock(){
  if(World.frameCount%90 === 0){
    var oImage = createSprite(monkey.x + 200,380,20,20);
...
function createFood(){
  if(World.frameCount%60 === 0){
    var fImage = createSprite(monkey.x + 200,300,20,20);
